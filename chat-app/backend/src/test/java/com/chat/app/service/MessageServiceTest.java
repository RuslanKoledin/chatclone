...
class MessageServiceTest extends AbstractIntegrationTest {
    ...
    void sendMessage() throws ChatException, UserException, MessageException {
        ...
        SendMessageRequestDTO request = new SendMessageRequestDTO(vaderAndLukesChatId, content, null);
        ...
        SendMessageRequestDTO request2 = new SendMessageRequestDTO(notExistingId, "Should not work", null);
